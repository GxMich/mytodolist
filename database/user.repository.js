...
const findUser = (credenziale, password, callback) => {
    const sql = 'SELECT id, username, email, password_hash, photo_url FROM users WHERE username = ? OR email = ?';
...
const getUserById = (userId, callback) => {
    const sql = 'SELECT id, username, email, photo_url FROM users WHERE id = ?';
...
const updatePhotoUrl = (userId, photoUrl, callback) => {
